...
ACraftWarpPoint::ACraftWarpPoint()
{
	// Ensure we can control the load of LevelWarp by datalayer
	bIsSpatiallyLoaded = false;
}

void ACraftWarpPoint::BeginPlay()
{
	Super::BeginPlay();
...
bool ACraftWarpPoint::SynchronizeDataToCraftWords()
{
	...
	if (CraftWorld)
	{
		...
		// Call normal
		CraftWorld->OnWarpDataUpdateInternal.AddLambda([CraftWorld,this](UNativeCraftWorld*, ACraftWarpPoint*)
		{
